...
static const struct ble_gatt_svc_def gatt_svr_svcs[] = {
    ...
    {
        // Service: Generic Attribute (for Service Changed)
        .type = BLE_GATT_SVC_TYPE_PRIMARY,
        .uuid = BLE_UUID16_DECLARE(0x1800), // Generic Attribute Service
        .characteristics =
            (struct ble_gatt_chr_def[]){
                {
                    // Characteristic: Service Changed
                    .uuid = BLE_UUID16_DECLARE(GATT_SERVICE_CHANGED_UUID),
                    .access_cb = gatt_svr_chr_service_changed_cb,
                    .flags = BLE_GATT_CHR_F_READ | BLE_GATT_CHR_F_NOTIFY,
                    .val_handle = &service_changed_val_handle,
                },
                {
                    0,
                }},
